...
ROUTE_DB = {
    "파나마 운하 (아시아-미주)": {
        ...
        "standard_path": {"lat": [35.1, 20.0, 9.38, 24.0, 40.7], "lon": [129.0, -150.0, -79.92, -74.0, -74.0]},
        "alternatives": [
            {"route_name": "우회: 수에즈 운하 경유", "transit_time_days": 34, "cost_index_pct": 130, "safety_score": 80,
             ...
             "path_lat": [35.1, 1.3, 27.5, 36.0, 40.7], "path_lon": [129.0, 103.8, 34.0, -5.6, -74.0]}
        ]
    },
    "수에즈 / 홍해 (아시아-유럽)": {
        ...
        "standard_path": {"lat": [35.1, 12.5, 31.0, 51.9], "lon": [129.0, 44.0, 32.3, 4.3]},
        "alternatives": [
            {"route_name": "우회: 아프리카 희망봉", "transit_time_days": 38, "cost_index_pct": 142, "safety_score": 95,
             ...
             "path_lat": [35.1, -34.8, 0.0, 51.9], "path_lon": [129.0, 20.0, -10.0, 4.3]}
        ]
    },
    "호르무즈 해협 (중동-동아시아)": {
        ...
        "standard_path": {"lat": [27.0, 15.0, 1.3, 35.1], "lon": [50.2, 68.0, 103.8, 129.0]},
        "alternatives": [
            {"route_name": "대체: 얀부항(홍해) 파이프라인 연계", "transit_time_days": 19, "cost_index_pct": 135, "safety_score": 85,
             ...
             "path_lat": [24.1, 10.0, 1.3, 35.1], "path_lon": [38.0, 60.0, 103.8, 129.0]}
        ]
    },
    "말라카 해협 (동남아-동아시아)": {
        ...
        "standard_path": {"lat": [1.3, 5.5, 22.0, 35.1], "lon": [103.8, 98.0, 120.0, 129.0]},
        "alternatives": [
            {"route_name": "우회: 순다/롬복 해협", "transit_time_days": 12, "cost_index_pct": 125, "safety_score": 90,
             ...
             "path_lat": [-8.7, -3.0, 18.0, 35.1], "path_lon": [115.8, 118.5, 128.0, 129.0]}
        ]
    }
}
